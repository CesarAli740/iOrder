...
<body>
    <center><h1>Reportes Reservas</h1></center>
    <div class="container">
        <h2>Filtrar por Fecha de reserva</h2>
        <form action="generar_reportes_reservas.php" method="post" class="container-form">
    ...
    <script>
        function generarPDF() {
            window.location.href = 'generar_reporte_reservas_pdf.php?' +
